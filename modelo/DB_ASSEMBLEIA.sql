...
CREATE TABLE IF NOT EXISTS TB_BLOCOS(
    ...
    BLO_NOME VARCHAR(25) NOT NULL,
    BLO_APELIDO VARCHAR(25),
    CONSTRAINT PRIMARY KEY(PK_BLO),
    CONSTRAINT UK_BLO_NOME UNIQUE KEY(BLO_NOME),
    CONSTRAINT UK_BLO_APELIDO UNIQUE KEY(BLO_APELIDO)
);
...
VALUES 
    ...
    ('AUMENTO DA TAXA DE CONDOMÍNIO',2),
    ('TAXA EXTRA PARA AMPLIAÇÃO DA ACADEMIA',3),
    ('COMPRA DE LIXEIRAS PARA OS HALLS',1);
